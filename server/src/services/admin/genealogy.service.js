 ...
 * Delegates to the shared genealogy service.
 * @param {string} associateId
 * @param {number} depth
 */
export async function adminGetTree(associateId, depth = 5) {
 ...
 * @param {string} associateId
 */
export async function adminGetBusinessTracking(associateId) {
