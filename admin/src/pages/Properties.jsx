      ...
      <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button onClick={handleUpload} disabled={uploading || !files} className="rounded-lg bg-gold-500 px-4 py-2 text-sm font-medium text-white hover:bg-gold-600 disabled:opacity-50">
      ...
      <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button onClick={handleUpload} disabled={uploading || !file} className="rounded-lg bg-gold-500 px-4 py-2 text-sm font-medium text-white hover:bg-gold-600 disabled:opacity-50">
              {uploading ? t('common.loading') : 'Upload'}
            </button>
          </div>
        </div>
